...
model = dict(
    ...
    backbone=dict(
        ...
        'data/pretrain_models/c3d_sports.pth',  # noqa: E501
        style='pytorch',
...
test_pipeline = [
    dict(
        ...
        test_mode=True),
    dict(type='RawFrameDecode'),
    # dict(type='Resize', keep_ratio=False, scale=(128, 171)),
    dict(type='Resize', keep_ratio=False, scale=(171, 128)),
    dict(type='CenterCrop', crop_size=112),
    dict(type='Flip', flip_ratio=0),
    dict(type='Normalize', **img_norm_cfg),
    dict(type='FormatShape', input_format='NCTHW'),
...
# optimizer
optimizer = dict(
    type='SGD', lr=0.001 * 6 / 8, momentum=0.9,
